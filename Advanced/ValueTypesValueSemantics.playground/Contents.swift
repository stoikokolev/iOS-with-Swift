...
struct CourseAssignment {
    var course: Course
    var createdByStudent: Student
    var gradedByTeacher: Teacher
}
...
do {
    ...
    let courseAssignment = CourseAssignment(course: course, createdByStudent: students.first!, gradedByTeacher: teacher)
    
    var imposterCourseAssignment = courseAssignment
    imposterCourseAssignment.createdByStudent = students[3]
    
    print(courseAssignment.createdByStudent.name)
}
